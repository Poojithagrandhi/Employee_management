      ...
      <div class="col-md-6 ">
        ...
        <div class="card-body">
            <table>
                ...
                <tr >
                    <th>Employee id</th>
                    <td> <input type="text" class="form-control" name="id" value="<%= request.getParameter("b") %>" required="required"/></td></tr>
            </div>                 
                <div class="form-group">
                <tr >
                    <th>Name</th>
                    <td> <input type="text" class="form-control" name="name" value="<%= request.getParameter("c") %>" required="required"/></td></tr>
            </div>
            <div class="form-group">
                <tr>
                    <th>Email Id</th>
                    <td><input type="text" class="form-control" name="em" value="<%= request.getParameter("d") %>" required="required"/></td></tr>
            </div>
            <div class="form-group">
                <tr>
                    <th>Password</th>
                    <td><input type="text" class="form-control" name="pwd" value="<%= request.getParameter("e") %>" required="required"/></td></tr>
            </div>
                <div class="form-group">
                <tr >
                    <th>Address</th>
                    <td> <input type="text" class="form-control" name="addr" value="<%= request.getParameter("f") %>" required="required"/></td></tr>
            </div>
                <div class="form-group">
                <tr >
                    <th>Phone</th>
                    <td> <input type="text" class="form-control" name="ph" value="<%= request.getParameter("g") %>" required="required"/></td></tr>
            </div>
                <div class="form-group">
                <tr >
                    <th>Department Id</th>
                    <td> <input type="text" class="form-control" name="did" value="<%= request.getParameter("h") %>" required="required"/></td></tr>
            </div>
                
                <div class="form-group">
                <tr >
                    <th>Post</th>
                    <td> <input type="text" class="form-control" name="post" value="<%= request.getParameter("j") %>" required="required"/></td></tr>
            </div>
                    <div class="form-group">
                <tr >
                    <th>Salary</th>
                    <td> <input type="text" class="form-control" name="sal" value="<%= request.getParameter("k") %>" required="required"/></td></tr>
            </div>
           <div class="form-group">
                    ...
                    <%
                        ...
                        connects co=new connects();
                            ...
                            PreparedStatement ps1=con.prepareStatement("update employee set empid=?,name=?,email=?,password=?,phone=?,address=?,deptid=?,post=?,salary=? where id=?");
                            ps1.setString(1, id);
                            ...
                            ps1.setString(9, sal);
                            ps1.setInt(10, Integer.parseInt(request.getParameter("a")));
