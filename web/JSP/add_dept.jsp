      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                ...
                <div class="container">
      <div class="col-md-6 ">
        <div class="card-header bg-warning">ADD DEPARTMENT</div>
        <div class="card-body">
            <table>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <%
                        ...
                        PreparedStatement ps=con.prepareStatement("select * from dept where num=?");
                        ps.setString(1, id);
                        ...
                        if(z==0)
                        {
                            PreparedStatement ps2=con.prepareStatement("insert into dept(num,name) values(?,?)");
                            ps2.setString(1, id);
                            ...
                            if(b==0)
                            {
                                ...
                                <div class="alert alert-danger">
                                    <strong>Failed to insert department details</strong>
                                </div>
                                <%
                            }
                            else
                            {
                                ...
                                <div class="alert alert-success">
                                    <strong>Successfully inserted department details</strong>
                                </div>
                                <%
                            }
                        }
                        else
                        {
                           %>
                                <div class="alert alert-warning">
                                    <strong>Department Id is already present.</strong>
                                </div>
                                <%  
                        }
                        }
