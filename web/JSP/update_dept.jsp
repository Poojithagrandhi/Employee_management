      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                ...
                <div class="container">
      <div class="col-md-6 ">
        <div class="card-header bg-warning">UPDATE DEPARTMENT</div>
        <div class="card-body">
            <table>
            ...
            <div class="form-group">
                ...
                <tr>
                    <th>Name</th>
                    <td><input type="text" class="form-control" name="name" value="<%= request.getParameter("c") %>" /></td></tr>
            </div>
                <div class="form-group">
                    ...
                    <%
                        ...
                        connects co=new connects();
                            ...
                            PreparedStatement ps2=con.prepareStatement("update dept set num=?,name=? where id=?");
                            ps2.setString(1, id);
                            ps2.setString(2, name);
                            ps2.setInt(3, Integer.parseInt(request.getParameter("a")));
                            ...
                            if(b==0)
                            {
                                ...
                                <div class="alert alert-danger">
                                    <strong>Failed to update department details</strong>
                                </div>
                                <%
                            }
                            else
                            {
                                ...
                                <div class="alert alert-success">
                                    <strong>Successfully updated department details</strong>
                                </div>
                                <%
                            }
