...
<script>
var nam=/[a-zA-Z]{4,15}/;
var em=/[a-zA-Z]{4,15}@(gmail)\.(com)/;
var ph=/(91|0)[0-9]/;
var pwd=/[A-Z]{1}[a-zA-z0-9]{3,10}/;
function show()
{
    //alert("SHOW");
    ...
    if(!a.match(nam))
    {
        document.getElementById('val').innerHTML="enter proper first name";
        document.getElementById('name').focus();
	return false;
    }
     if(!b.match(em))
    {
        document.getElementById('val').innerHTML="enter proper email id";
        document.getElementById('em').focus();
	return false;
    }
     if(!c.match(ph))
    {
        document.getElementById('val').innerHTML="enter proper phone number";
        document.getElementById('ph').focus();
	return false;
    }
     if(!d.match(pwd))
    {
        document.getElementById('val').innerHTML="enter proper password";
