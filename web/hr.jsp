                            ...
                            <div class="col-md-6 col-sm-6" style="margin-left: 30%">
                                <div class="toggle-content text-center" id="tab1">
                                    <div class="card card-login mx-5 mt-5">
                                        <div class="card-header"><font size='5'>HR MANAGER LOGIN</font></div>
                                      <div class="card-body">
                                        ...
                                        <%
                                            ...
                                            session.setAttribute("hrl", uname1);
                                            connects co=new connects();
                                            Connection con=co.con();
                                            PreparedStatement ps=con.prepareStatement("select * from manager where email=? and password=? and post='HR'");
                                            ...
                                            {
                                                response.sendRedirect("JSP/hradmin.jsp");
                                            }
                                            }
                                            %>
                                      </div>
