        ...
        <div class="card-body">
          ...
          <%      
               ...
               if(email==null)
               {
                ...
                Connection con=co.con();
                  PreparedStatement ps=con.prepareStatement("select * from quiz where id=91");
            ...
            <div class="form-group">
              <div class="form-label-group">
                 ...
                 <div><%= "10.)" %><%= rs.getString("question") %></div>
              </div>
            </div>
              <div>
          ...
          <%
                 if(request.getMethod().equalsIgnoreCase("post"))
                  ...
                  if(a1==b1)
                  {
                      PreparedStatement ps1=con.prepareStatement("update quiz_attempt set status=1 where qno=10 and name=?");
                      ps1.setString(1, email);
                      ps1.executeUpdate();
                  }
                  else
                  {
                       PreparedStatement ps1=con.prepareStatement("update quiz_attempt set status=0 where qno=10 and name=?");
                      ps1.setString(1, email);
                      ps1.executeUpdate();
                  }
