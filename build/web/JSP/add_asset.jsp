            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <%
                        ...
                        PreparedStatement ps=con.prepareStatement("select * from asset where num=?");
                        ps.setString(1, id);
                        ...
                        if(z==0)
                        {
                            PreparedStatement ps2=con.prepareStatement("insert into asset(num,name) values(?,?)");
                            ps2.setString(1, id);
                        ...
                        else
                        {
                           %>
                                <div class="alert alert-warning">
                                    <strong>Asset Id is already present.</strong>
                                </div>
                                <%  
                        }
                        }
