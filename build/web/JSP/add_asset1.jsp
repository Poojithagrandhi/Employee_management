      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                ...
                <div class="container">
      <div class="col-md-6 ">
        <div class="card-header bg-warning">ADD ASSET</div>
        <div class="card-body">
            <table>
            ...
            <div class="form-group">
                ...
                <tr>
                    <th>Model</th>
                    <td><input type="text" class="form-control" name="model"  /></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>RAM</th>
                    <td><input type="text" class="form-control" name="ram"  /></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>ROM</th>
                    <td><input type="text" class="form-control" name="rom"  /></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>Core</th>
                    <td><input type="text" class="form-control" name="core"  /></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>Size</th>
                    <td><input type="text" class="form-control" name="size"  /></td></tr>
            </div>
                <div class="form-group">
                <tr>
                    <th>Emp. ID</th>
                    <td><input type="text" class="form-control" name="empid"  /></td></tr>
            </div>
                ...
                <div class="form-group">
                    ...
                    <%
                       ...
                       connects co=new connects();
                            ...
                            PreparedStatement ps2=con.prepareStatement("insert into asset_desc(number,model,ram,rom,core,size,empid) values(?,?,?,?,?,?,?)");
                            ps2.setString(1, id);
                   
                            ps2.setString(2, model);
                            ps2.setString(3, ram);
                            ps2.setString(4, rom);
                            ps2.setString(5, core);
                            ...
                            if(b==0)
                            {
                                ...
                                <div class="alert alert-danger">
                                    <strong>Failed to insert asset details</strong>
                                </div>
                                <%
                            }
                            else
                            {
                                ...
                                <div class="alert alert-success">
                                    <strong>Successfully inserted asset details</strong>
                                </div>
                                <%
                            }
