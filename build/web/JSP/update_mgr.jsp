      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                ...
                <div class="container">
      <div class="col-md-6 ">
        <div class="card-header bg-warning">UPDATED MANAGER</div>
        <div class="card-body">
            <table>
            ...
            <div class="form-group">
                <tr >
                    <th>Name</th>
                    <td> <input type="text" class="form-control" name="name" value="<%= request.getParameter("b") %>" required="required"/></td></tr>
            </div>
                  <div class="form-group">
                <tr >
                    <th>Employee id</th>
                    <td> <input type="text" class="form-control" name="id" value="<%= request.getParameter("c") %>" required="required"/></td></tr>
            </div>                 
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  <tr>
                      ...
                      <option><%= request.getParameter("f") %></option>
                ...
                <div class="form-group">
                    ...
                    <%
                        ...
                        connects co=new connects();
                            ...
                            PreparedStatement ps1=con.prepareStatement("update manager set name=?,empid=?,email=?,password=?,post=? where id=?");
                            ps1.setString(1, name);
                            ps1.setString(2, id);
                            ps1.setString(3, em);
                            ps1.setString(4, pwd);
                            ps1.setString(5, post);
                            ps1.setInt(6, Integer.parseInt(request.getParameter("a")));
