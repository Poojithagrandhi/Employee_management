    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
              ...
              <a class="dropdown-item" href="login.jsp">Team Lead</a>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="container">
      <div class="col-md-6 ">
        <div class="card-header bg-warning">TEAM LEAD LOGIN</div>
        <div class="card-body">
                                ...
                                <div class="toggle-content text-center" id="tab1">
                                    <table>
                                        ...
                                        <%
                                            ...
                                            PreparedStatement ps=con.prepareStatement("select * from team_lead where email=? and password=?");
